...
public class FotoFacadeREST extends AbstractFacade<Foto> {
    ...
    @PersistenceContext(unitName = "NegocioAgregarFoto-warPU")
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Long id, Foto entity) {
        super.edit(entity);
    }
    ...
    public Foto find(@PathParam("id") Long id) {
