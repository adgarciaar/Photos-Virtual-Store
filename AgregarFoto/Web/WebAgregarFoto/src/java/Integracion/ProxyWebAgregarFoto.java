...
/**
 * Jersey REST client generated for REST resource:FotoFacadeREST
 * [entities.foto]<br>
 * USAGE:
 * <pre>
 *        ProxyWebAgregarFoto client = new ProxyWebAgregarFoto();
 ...
 */
public class ProxyWebAgregarFoto {
    ...
    public ProxyWebAgregarFoto() {
        ...
        webTarget = client.target(BASE_URI).path("entities.foto");
    }
